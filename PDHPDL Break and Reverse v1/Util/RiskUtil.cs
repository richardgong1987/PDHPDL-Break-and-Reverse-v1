...
namespace cAlgo.Robots {
    ...
    public static class RiskUtil {
        ...
        /// </summary>
        public static double NormalizeVolume(double volume, double minVolume, double maxVolume, double volumeStep) {
        ...
        /// </summary>
        public static double CalcVolumeByRisk(double equity, double riskPct, double entry, double stop, double tickSize, double tickValue,
            double minVolume, double maxVolume, double volumeStep) {
